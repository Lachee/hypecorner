...
namespace HypeCorner.Logging
{
	...
	public class FileLogger : ILogger
	{
		...
		public void Trace(string message, string application = "app", params object[] args)
		{
			...
			lock (filelock) System.IO.File.AppendAllText(File, $"\r\n[ TRCE ] [ {application} ] " + (args.Length > 0 ? string.Format(message, args) : message));
		}
		...
		public void Info(string message, string application = "app", params object[] args)
		{
			...
			lock (filelock) System.IO.File.AppendAllText(File, $"\r\n[ INFO ] [ {application} ] " + (args.Length > 0 ? string.Format(message, args) : message));
		}
		...
		public void Warning(string message, string application = "app", params object[] args)
		{
			...
			lock (filelock)
				System.IO.File.AppendAllText(File, $"\r\n[ WARN ] [ {application} ] " + (args.Length > 0 ? string.Format(message, args) : message));
		}
		...
		public void Error(string message, string application = "app", params object[] args)
		{
			...
			lock (filelock)
				System.IO.File.AppendAllText(File, $"\r\n[ ERRO ] [ {application} ] " + (args.Length > 0 ? string.Format(message, args) : message));
		}
